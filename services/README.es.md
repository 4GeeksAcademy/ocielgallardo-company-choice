...
- Consumidor frontend (AUTH-02 fases 1–2): el backoffice guarda el JWT en `localStorage` y envía Bearer vía `uis/backoffice/lib/services/healthcoreClient.ts` (`/login`, `/register`).
