...
-Empresa: HealthCore empresa que trabaja en el sector de la salud.
-Razón de la elección: Problemas reales y en crecimiento a resolver, con un volumen estable de clientes.
-Visión: Creo que aporta bastante dificultad a mi proyecto, lo cual deseo para mi beneficio durante mi aprendizaje en todo el curso.
-Portafolio: Seguramente dará un buen aporte a mi portafolio en desarrollo.
-Datos: Trabaja con datos sensibles, lo que me aportará más conocimiento en el uso de datos y su seguridad
...
Reto:
-Sistema inteligente que predice pérdidas de ingresos y actúa automáticamente para evitarlas.
